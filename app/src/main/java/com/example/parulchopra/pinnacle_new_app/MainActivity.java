...
public class MainActivity extends AppCompatActivity implements SelectSubjectsFragment.SubjectSelectListener {
    ...
    @Override
        ...
        Intent i= new Intent(this,OnSunjectSelectedActivity.class);
